...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/supply--chain-logistics-orange.svg" alt="Topic">
  <img src="https://img.shields.io/badge/status-production--ready-brightgreen.svg" alt="Status">
</p>


*Advanced transportation optimization for enterprise supply chain operations*

---

## 📋 Overview

**Transport Mode Selector** addresses a critical challenge in modern supply chain management: transportation. This implementation combines rigorous academic methodology with production-ready Python code, suitable for both research and enterprise deployment.

Built on the foundational work of **Professor Donald Bowersox**, this tool provides supply chain professionals with an analytical framework that transforms raw operational data into actionable optimization decisions. Whether you're managing a single warehouse or a global multi-echelon network, this toolkit scales to your complexity.
...
Supply chain transportation is a persistent operational challenge that impacts cost, service, and working capital across the enterprise. Organizations that fail to optimize transportation typically see:
...
```bash
git clone https://github.com/virbahu/transport-mode-selector.git
cd transport-mode-selector
pip install -r requirements.txt
python transport_mode_selector.py
```
...
```python
# Quick start example
from transport_mode_selector import *
...
# See docstrings in transport_mode_selector.py for full parameter reference
```
...
| | |
|---|---|
| **Based on** | Professor Donald Bowersox, Michigan State |
| **Key Reference** | See academic references for Professor Donald Bowersox |
